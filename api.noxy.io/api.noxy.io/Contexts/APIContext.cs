...
namespace api.noxy.io.Context
{
    public class APIContext : DbContext
    {
        ...
        public DbSet<FeatEntity> Feat { get; set; }
        public DbSet<RecruitmentModifierEntity> RecruitmentModifier { get; set; }
        ...
        public DbSet<AffinityEntity> Affinity{ get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FeatEntity>(FeatEntity.AddTableToBuilder);
            modelBuilder.Entity<RecruitmentModifierEntity>(RecruitmentModifierEntity.AddTableToBuilder);

            modelBuilder.Entity<UnitEntity>(UnitEntity.AddTableToBuilder);
            modelBuilder.Entity<AffinityEntity>(AffinityEntity.AddTableToBuilder);
            modelBuilder.Entity<ProfessionEntity>(ProfessionEntity.AddTableToBuilder);
